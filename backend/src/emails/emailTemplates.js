export function createWelcomeEmailTemplate(name, clientURL) {
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #000; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f2f2f2;">
    ...
    <div style="background-color: #000; padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
      <img src="https://img.freepik.com/free-vector/hand-drawn-message-element-vector-cute-sticker_53876-118344.jpg" 
           alt="Messenger Logo" 
           style="width: 80px; height: 80px; margin-bottom: 20px; border-radius: 50%; background-color: #fff; padding: 10px;">
      <h1 style="color: #fff; margin: 0; font-size: 28px; font-weight: 500;">
        Welcome to Messenger
      </h1>
    </div>

    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 10px rgba(0,0,0,0.08);">
      ...
      <div style="background-color: #f7f7f7; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #000;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href=${clientURL} 
           style="background-color: #000; color: #fff; text-decoration: none; padding: 12px 30px; border-radius: 50px; font-weight: 500; display: inline-block;">
          Open Messenger
        </a>
      </div>
      ...
      <p style="margin-top: 25px; margin-bottom: 0;">
        Best regards,<br>The Messenger Team
      </p>
    </div>
    ...
    <div style="text-align: center; padding: 20px; color: #777; font-size: 12px;">
      ...
      <p>
        ...
        <a href="#" style="color: #000; text-decoration: none; margin: 0 10px;">Terms of Service</a>
        <a href="#" style="color: #000; text-decoration: none; margin: 0 10px;">Contact Us</a>
      </p>
    </div>
